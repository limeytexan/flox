...
# Variable for storePath of "develop" package file generated by pkgdb, if known.
# Default to any storepath if building with Nix flakes.
declare pkgdbDevelopPackage="@out@"
...
time {
  if [ "$buildMethod" = "nix" ]; then
    ...
    pkgdbDevelopPackage="$(realisePkgdb)"
    inputSrcs=("$pkgdbDevelopPackage")
  fi
}
...
builtins.derivation {
  ...
  manifest = /. + $manifest;
  # All three of the following are storepaths.
  pkgdbDevelopPackage = $pkgdbDevelopPackage;
